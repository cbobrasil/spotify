...
Rode este script UMA VEZ, localmente, apontando EXPORT_DIR para a pasta
onde você extraiu o export. Depois é só commitar o historico.csv
resultante — a Action continua rodando normalmente a partir daí.
